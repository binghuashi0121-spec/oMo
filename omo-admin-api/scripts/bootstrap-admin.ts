...
async function main() {
  ...
  await repository.createAdmin({ id: randomUUID(), username, displayName, role: 'super_admin', passwordHash: await hashPassword(password), mustChangePassword: true, active: true, createdAt: now, updatedAt: now });
